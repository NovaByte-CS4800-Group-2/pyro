		...
		<>
		  <div className="m-10 ml-30 mr-30 text-center flex flex-col">
			...
			<Form action={registerUser} className="flex flex-col w-full max-w-80 m-auto mt-8 font-normal">
				...
				<input id="name" type="text" className="border-(liver) border-2 mb-6 p-2"></input>
				<label htmlFor="email" className="self-start">Email</label>
				<input id="email" type="email" className="border-(liver) border-2 mb-6 p-2"></input>
				<label htmlFor="username" className="self-start">Username</label>
				<input id="username" type="text" className="border-(liver) border-2 mb-6 p-2"></input>
				...
				<input id="zipcode" type="text" inputMode="numeric" pattern="[0-9]{5}" className="border-(liver) border-2 mb-6 p-2"></input>
