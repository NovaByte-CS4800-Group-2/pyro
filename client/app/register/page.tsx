...
import {
  ...
  checkValidUsername,
  registerUser,
} from "../server_functions/functions";
  ...
  return (
    <>
      <div className="m-10 ml-30 mr-30 text-center flex flex-col">
        <h1 className="text-3xl font-display pb-2 font-bold">
          Create New Account
        </h1>
        <h2 className="text-l font-display">
          Already Registered?{" "}
          <Link href="/log-in" className="font-semibold hover:underline">
            Log in
          </Link>
        </h2>
        <form
        ...
        >
          <div className="flex flex-col pb-4">
            ...
            />
            {errors.name && (
              <p className="text-sm text-red-500 self-end pr-1">
                {errors.name}
              </p>
            )}
          </div>
          ...
          <div className="flex flex-col pb-4">
            <label htmlFor="zipCode" className="self-start">
              Zip Code
            </label>
            <input
              id="zipCode"
          ...
          {errors.form && (
            <p className="text-sm text-red-500 self-center mt-3 max-w-50">
              {errors.form}
            </p>
          )}
        </form>
