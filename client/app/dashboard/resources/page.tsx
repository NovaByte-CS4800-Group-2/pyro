...
export default function Resources() {
	...
	return (
		<div className="flex flex-col text-center bg-[--greige-mist] gap-y-5 mx-6 w-full h-fullpt-1">
			<h2 className="text-left text-2xl font-bold font-display mt-8">Wildfire Preparedness</h2>
			<div className="flex flex-wrap gap-x-10 gap-y-10"> 
				{/* Resource Card */}
				<div className="max-w-xs text-left bg-[--porcelain] rounded-2xl shadow-md">
					<img 
					...
					<div className="p-4">
						...
						<button
							...
							className="mt-3 text-sm text-[--deep-terracotta] hover:text-[--muted-terracotta]"
						>
							Copy Link
						</button>
						{/* Custom Toast for the link copy */
						activeToastUrl === "https://readyforwildfire.org/prepare-for-wildfire/emergency-supply-kit/" && (
						<div className="toast text-sm mt-2 text[--deep-terracotta]">
							<p>Link copied to clipboard!</p>
						</div>
						)}
					</div>
				</div>
				<div className="max-w-xs bg-[--porcelain] text-left rounded-2xl shadow-md">
					<img 
			...
			<h2 className="text-left text-2xl font-bold font-display mt-8">Wildire Survival</h2>
			<div className="flex flex-wrap gap-x-10 gap-y-10"> 
				{/* Resource Card */}
				<div className="max-w-xs text-left bg-[--porcelain] rounded-2xl shadow-md">
					<img 
				...
				<div className="max-w-xs bg-[--porcelain] text-left rounded-2xl shadow-md">
					...
					/>
					<div className="p-4">
						<p className="text-sm text-[--deep-moss] dark:text-[--olive-stone] uppercase tracking-wide mb-2">Los Angeles Fire Department</p>
			...
			<h2 className="text-left text-2xl font-bold font-display mt-8">Wildfire Response</h2>
			<div className="flex flex-wrap gap-x-10 gap-y-10 "> 
				{/* Resource Card */}
				<div className="max-w-xs text-left bg-[--porcelain] rounded-2xl shadow-md">
					<img 
