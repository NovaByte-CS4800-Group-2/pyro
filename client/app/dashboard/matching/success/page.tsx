	...
	return (
		<div className="flex-grow flex flex-col items-center justify-center">
			<div className="flex flex-col gap-y-3 items-center max-w-[500px] shadow-md w-3/4 border-1 border-neutral-200 text-lg p-5 rounded-xl">
				...
				<p className="text-center mb-2">You have been matched successfully! We have sent you a notification with your match's email address! Contact them to discuss your housing agreement.</p>
