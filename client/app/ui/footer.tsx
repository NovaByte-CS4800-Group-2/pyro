	...
	return (
		<div className="flex bg-(--liver) border-t-2 border-(--liver) w-full h-18 font-display mt-auto">
			<div className="w-1/3 self-end pb-1 pl-1">
  				<p style={{ color: "var(--seashell)" }}>&copy; 2025 Nova Byte</p> 
  			</div>
			<Link target="_blank" href="https://novabyte-cs4800-group-2.github.io/NovaByte-website/" className="flex justify-center items-center w-1/3 bg-(--liver)">
